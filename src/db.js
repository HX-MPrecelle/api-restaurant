...
const sequelize = new Sequelize(`postgres://postgres:Maroni654@localhost:5432/restaurant`, {
...
const { Reserve, Restaurant, Review, User, Type, Neighborhood } = sequelize.models;
